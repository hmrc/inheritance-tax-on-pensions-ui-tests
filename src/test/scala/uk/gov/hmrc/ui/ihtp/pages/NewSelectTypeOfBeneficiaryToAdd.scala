...
object NewSelectTypeOfBeneficiaryToAdd extends BasePage {
  override val pageUrl: String   = s"$baseUrl/select-beneficiary-type/1"
  override val pageTitle: String =
    "Select the type of beneficiary to add - Report Inheritance Tax on a pension - GOV.UK"
  val pageHeading: String        = "Select the type of beneficiary to add"
