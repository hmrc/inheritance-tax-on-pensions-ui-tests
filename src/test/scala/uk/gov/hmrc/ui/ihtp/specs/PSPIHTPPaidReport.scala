...
class PSPIHTPPaidReport extends BaseSpec {

  Feature("Paid reports page for a PSP") {

    Scenario("1. PSP User Can go to the View Paid Reports page from the Overview Page") {

      Given("the user is logged in as an organisation user")
      AuthLoginPage.loginAsPspOrgUserForSubmission()
